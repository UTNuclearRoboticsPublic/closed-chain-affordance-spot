"""Robot-specific CCA settings for spot_arm.

Author: Crasun Jans

This module centralizes all robot-specific configuration for spot_arm
...
def define_robot_paths_and_settings():
    ...
    return {
        ...
        "cca_robot_package": "cca_spot_arm",
        "cca_robot_ros_setup_path": os.path.join(
            get_package_share_directory("cca_spot_arm"),
            "config",
            "cca_spot_arm_ros_setup.yaml"
        ),
        "cca_robot_ros_viz_setup_path": os.path.join(
            get_package_share_directory("cca_spot_arm"),
            "config",
            "cca_spot_arm_ros_viz_setup.yaml"
        ),
        "cca_robot_description_path": os.path.join(
            get_package_share_directory("cca_spot_arm"),
            "config",
            "cca_spot_arm_description.yaml"
        ),
        "cca_robot_urdf_path": os.path.join(
            get_package_share_directory("cca_spot_arm"),
            "config",
            "cca_spot_arm_urdf.yaml"
        ),
    }
