"""ROS 2 launch script to launch the CCA planner for the tasks defined in src/cca_spot_arm_node.cpp

Author: Crasun Jans

This script launches the CCA planner for the tasks defined in src/cca_spot_arm_node.cpp by loading the node with
...
### Usage:
    ...
    ros2 launch cca_spot_arm cca_spot_arm.launch.py debug:=true
====================================================================
